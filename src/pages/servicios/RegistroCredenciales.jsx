...
function Recursos() {
    ...
    const filteredEncuentros = encuentross
        .filter(encuentro => encuentro.beneficiario.toLowerCase().startsWith(searchTerm.toLowerCase()) || encuentro.prestador.toLowerCase().startsWith(searchTerm.toLowerCase()));
    return (
        <>
            <div className="row">
            ...
            <div className="card mx-auto rounded " style={{ width: "85%" }} >
                <h5 className="card-header">Registros de Credenciales<input type="text" className="form-control w-50 mx-auto" placeholder="Buscar por rut" value={searchTerm} onChange={handleSearch} /></h5>
